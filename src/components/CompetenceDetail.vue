<script setup lang="ts">
    ...
    */
    ...
    defineEmits(['ajouterCompetenceSpe'])
    ...
    */
    function showCompetence(id) {
        ...
        axios({
            method: "GET",
            "url": "http://localhost:3000/competences/competences/" + id
    ...
    function supprimer() {
        ...
        if (myProps.id != null) {
            ...
            axios({
                ...
                "url": "http://localhost:3000/competences/competences/" + myProps.id
            }).then(result => {
                console.log("Retour du service, :result.data: " + result.data);
                myVariables.competence = result.data;
...
<template>
    ...
    <div v-if="myVariables.competence">
        ...
        <button type="button" class="btn btn-sm btn-outline-primary " @click="$emit('ajouterCompetenceSpe')">
            <span data-feather="calendar" class="align-text-bottom"></span>
            Nouvelle competence specifique
        </button>
